...
public class AnimationFrame extends JFrame {
	...
	public AnimationFrame(Animation animation)
	{
		...
		lblScoreLabel.setBounds(80, 22, 112, 30);
		...
		lblScore.setBounds(208, 22, 320, 30);
		getContentPane().add(lblScore);
		getContentPane().setComponentZOrder(lblScore, 0);

		lblMessageLabel = new JLabel("Msg: ");
		lblMessageLabel.setForeground(Color.YELLOW);
		lblMessageLabel.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblMessageLabel.setBounds(300, 22, 128, 30);
		getContentPane().add(lblMessageLabel);
		getContentPane().setComponentZOrder(lblMessageLabel, 0);

		lblMessage = new JLabel("");
		lblMessage.setForeground(Color.YELLOW);
		lblMessage.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblMessage.setBounds(400, 22, this.SCREEN_WIDTH - 416, 30);
		getContentPane().add(lblMessage);
		getContentPane().setComponentZOrder(lblMessage, 0);
	...
	private void updateControls() {
		this.lblScore.setText(Long.toString(((CollidingSprite)player1).getScore()));
		this.lblMessage.setText(((CollidingSprite)player1).getProximityMessage());
		if (universe != null) {
